...
#define TFT_RST  12     // Set TFT_RST to -1 if the display RESET is connected to NodeMCU RST or 3.3V


#define TFT_BL 40  // LED back-light (only for ST7789 with backlight control pin)*/
